/*\
title: $:/bj/modules/widgets/mplylist.js
...
*/
MPlayListWidget.prototype.invokeAction = function(triggeringWidget,event) {
	if (event.type == "start") this.doStart();
	else this.doNext();
...
MPlayListWidget.prototype.doMove = function(loc) {
	...
	if(this.list.length === 0) {
		...
		for (i = 0; i < this.list.length; i++) {
			if ((loc == this.list[i]) && (tid = this.wiki.getTiddler(this.list[i])) && (tid.hasField("_canonical_uri"))) {
...
exports["action-mplaylist"] = MPlayListWidget;
